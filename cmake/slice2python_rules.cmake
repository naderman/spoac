...
# which is typically the same as the name of the namespace, e.g. 'spoac'
#get_filename_component( INTERFACE_NAMESPACE ${CMAKE_CURRENT_SOURCE_DIR} NAME )

set(INTERFACE_NAMESPACE spoac)
...
#   message( STATUS "GENERATE_SLICE2PY_RULES: ARGN: ${ARGN}" )
  ...
  foreach( SLICE_SOURCE_BASENAME ${ARGN} )
    APPEND( GEN_SLICE_RULES_SLICE_DEPENDS "${SLICE_SOURCE_DIR}/${SLICE_SOURCE_BASENAME}" )
  ...
  foreach( SLICE_SOURCE_BASENAME ${ARGN} )
    ...
    string( REGEX REPLACE "${INTERFACE_NAMESPACE}/" "" OUTPUT_BASENAME "${SLICE_SOURCE_BASENAME}" )
    string( REGEX REPLACE "\\.ice" _ice.py OUTPUT_BASENAME "${OUTPUT_BASENAME}" )
    ...
    add_custom_command(
        OUTPUT  ${CMAKE_CURRENT_BINARY_DIR}/${INTERFACE_NAMESPACE}/${OUTPUT_BASENAME}
...
#   message( STATUS "DEBUG: GENERATED_PY_LIST: ${${GENERATED_PY_LIST}}")
  ...
  message( STATUS "${SLICE2PY_COMMAND} ${SLICE_SOURCE_DIR}/${INTERFACE_NAMESPACE}/*.ice ${SLICE_ARGS}" )
